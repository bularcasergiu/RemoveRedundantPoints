...
public class DPfilter
{
  ...
  /**
   * implements the DouglasPeuckerAlgorithm on list of points 
   * that algorithm reduced the points into same way in function with same threshold(epsilon)
   * 
   * @return double[x.coordonate][y.coordonate]
   */
